...
Infrastructure engineering solved this a decade ago. When components are non-deterministic and fallible, you don't coordinate through the components - you move the guarantees into the layer they can't reach.
